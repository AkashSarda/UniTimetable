...
function utt_UniTimetableMenu_create(){
    ...
    $DPage = add_submenu_page( __FILE__, __("Overall Menu","UniTimetable"), __("Overall Menu","UniTimetable"), 'manage_options',__FILE__.'_overall_menu', 'utt_create_overall_page' );
    add_action('load-'.$DPage, 'utt_overall_scripts');
