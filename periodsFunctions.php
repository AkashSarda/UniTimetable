...
function utt_create_periods_page(){
    //period form
?>
   <div class="wrap container wrapper" style = "background-color : #d3d3d3">
	<h2 id="periodTitle"> <?php _e("Insert Period","UniTimetable"); ?> </br> </h2>
	<form action="" name="periodForm" method="post">
	    <div class = "col-sm-6">
	    		<input type="hidden" name="periodid" id="periodid" value=0 />
	         <label for = "year"> <?php _e("Year:","UniTimetable"); ?><br/> </label>
	    		<input type="number" name="year" id="year" class="form-control dirty" value="<?php echo date("Y"); ?>"/>
				<br/>       
       </div>
        
        <div class = "col-sm-6">
            <label for = "semester"><?php _e("Semester:","UniTimetable"); ?></label>
            <select name="semester" class="form-control dirty" id="semester" onchange="selectinput()">
	    ...
	    <!-- <input type="text" id="newSemester" name="newSemester" value="" class = "form-control col-sm-6" placeholder="Enter Semester" /> -->
            <br/>
          
            <div id="secondaryButtonContainer col-sm-6 container">
